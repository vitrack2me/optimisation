...
J2_3 = sum(C*(1:N).*cos(wb*(1:N)+phi)+2*A*(1:N).*cos(wb*(1:N)+phi).*sin(wb*(1:N)+phi)-(1:N).*cos(wb*(1:N)+phi).*data);
J2_4 = sum(C*cos(wb*(1:N)+phi)+2*A*cos(wb*(1:N)+phi)-cos(wb*(1:N)+phi).*data);


J3_1 = sum(A*(1:N).*cos(wb*(1:N)+phi));
J3_2 = sum(C*(1:N).*cos(wb*(1:N)+phi)+2*A*(1:N).*sin(wb*(1:N)+phi).*cos(wb*(1:N)+phi)-(1:N).*cos(wb*(1:N)+phi).*data;
